 ...
 */
public class MoracleDatabaseMetaData implements DatabaseMetaData {

    private static final Logger logger = LoggerFactory.getLogger(MoracleDatabaseMetaData.class);

    private MoracleConnection connection;

    public MoracleDatabaseMetaData(MoracleConnection connection) throws SQLException {
    ...
    public MoracleResultSet getPseudoColumns(String catalog, String schemaPattern, String tableNamePattern,
